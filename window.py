...
class Window:
    ...
    def makeWindow0(self, connected):
            ...
            content_layout = ([sg.Push(),sg.Text(f'Connect to The Conductor.',key='-OUTPUT-',font = ("Calibri", 16, "bold",), pad=(50,0)),sg.Push()], 
                    ...
                    [sg.Column([[sg.Button('Connect', key='-APCNTEBTN-', visible=disconnectVis,pad=(50,0))]]),sg.Column([[sg.Button("Don't Connect", key='-NOCNTBTN-', visible=disconnectVis ,pad=(0,0))]])],
    ...
    #Window one welcome, load / create model
        ...
        content_layout = [[sg.Text('The Conductor: Window 1',key='-OUTPUT-')],
